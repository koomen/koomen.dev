...
It's not hard to imagine how much time an email-reading agent like this could save me. It already seems to do a better job of detecting spam than Gmail's built-in spam filter. It's more powerful and easier to maintain than the byzantine set of filters I use today. With a few more tools it could send me a notification for every message that _I_ think is important, and when I open them up it could have a

It could use my email-writing agent to write draft responses to every important message. It could auto-archive everything I don't need to read and summarize everything I do.

Hell, with access a few additional tools it could unsubscribe from lists, schedule appointments, and pay my bills too.

These are all boring, repetitive tasks that I waste time doing by hand today. In the near future, I'll be able to teach a computer how to do them for me and once I do I'll never have to spend time on them again. I cannot wait.
...
One of the reasons I wanted to include real, working mini-apps in this essay was to demonstrate that large language models are already good enough to do this kind of work on our behalf. It's not a lack of AI smarts that is keeping us from the future I described in the previous section, it's app design.

In the Gmail case, it's hard for me to fathom what they were optimizing for, but I can tell you what _I_ want from an "AI-native" email client: to spend as little time using it as possible. 

I think the root of this problem is that the Gmail team set out to add AI to the Gmail client they already had, rather than asking themselves what an email client would look like if it were designed from ground up to use AI. This is what makes it a horseless carriage: it's a little bit of AI jammed into an app designed for repetitive human labor rather than an app for automating repetitive labor. 

This is, in my 

My guess is that the best AI-native apps will come in two flavors: 1) Apps



An

Although it has AI features, Gmail is not an "AI native" email client. 

An AI-native email client wouldn't force me to explain how I want emails written every time I need help writing one, it would allow me to teach an AI agent how I write emails _once_ so that I writes in my voice going forward. An AI-native email client would read emails for me so that I don't have to read them. It would find the most important messages so that I could focus my attention on the things that need it most. 





An "AI-native" email client is an app that enables me to spend as little time as possible doing email. 
