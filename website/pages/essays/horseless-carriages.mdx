---
title: Horseless Carriages | koomen.dev
description: I noticed something interesting the other day...
keywords: AI, software, design
author: Pete Koomen
ogImage: /images/steam-carriage.png
...
<PageWrapper 
    title="Horseless Carriages | koomen.dev"
    description="I noticed something interesting the other day..."
    image="/images/steam-carriage.png"
>
...
In this demo we're using AI to _read_ emails instead of write them from scratch. Each email is categorized and prioritized, and some are auto-archived while others get an automatically-drafted reply. The assistant uses a custom "System Prompt" to do all of this exactly the way I want it to.
...
There is a simple solution to this problem that I think many AI app developers are missing. To explore it, we need to take a look under the hood at what actually happens when the "Generate Draft" button is pressed.
...
I conclude from this that in most AI apps, System Prompts will be written and maintained by users, not software developers or even domain experts hired by developers.
...
Thanks to my Dad, PG and my colleages at YC for reading drafts of this essay.
