...
I am beginning to suspect that many of these apps are the "horseless carriages" of the AI era. They're bad because they mimic old ways of building software that unnecessarily constrain the AI models they're built with. As a result they've made it easy for a lot of people to dismiss AI.
...
And here we have our answer: Gmail's AI is braindead because _they taught it to be braindead_. It is braindead by design.
...
And of course in most cases the only way for developers to do this profitably is to build one piece of software for a large group of users. Developers are used to building one-size-fits-all software, and we're used to _using_ one-size-fits-all software.
