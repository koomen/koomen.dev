...
But I don’t want some anonymous Googler (and, presumably, a small army of lawyers) to decide how Gemini should write my emails. They’re **my** emails, goddamnit, and I want to make that decision for myself. And the beauty of LLMs is that for the first time in the history of software, I can actually do this without writing code.
