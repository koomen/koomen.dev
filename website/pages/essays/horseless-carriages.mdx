...
If you spend some time playing around with your own System Prompt, I think you'll be surprised at how much fun it is. There's something magical about teaching an LLM to solve a problem the same way you would and watching it succeed. Interestingly it's actually _easier_ than teaching a human because, unlike a human, and LLM will give you instantaneous, honest feedback about whether your explanation was good enough or not.

Before we move on, let's take stock of what we've done here. By exposing the System Prompt and making it editable, we've created a product experience that produces better results and is _actually fun to use_. Why didn't the Gmail team do this in the first place?
