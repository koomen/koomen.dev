...
Millions of Gmail users have had this experience and I'm sure many of them have concluded that AI isn't smart enough to help them with their email yet.

This could not be further from the truth: Gemini is an astonishingly powerful model. The problem is that the Gmail team designed an app that prevents it . 
