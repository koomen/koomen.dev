...
So what are we actually waiting on?
...
I think the root of this problem is that the Gmail team set out to add AI to the Gmail client they already had, rather than asking themselves what an email client would look like if it were designed from ground up to use AI. This is what makes it a horseless carriage: it's a little bit of AI jammed into an app designed for repetitive human labor rather than an app designed for automating repetitive labor.

This is what an AI-native app is: an app designed from the ground up to maximize the output of human effort by automating repetitive work. An AI-native IDE maximizes the amount of software I can create per unit of effort. An AI-native email client minimizes the amount of effort I spend doing email.

An AI-native app is designed to give human beings **leverage**.
