...
My core contention in this essay is that AI applications that do work my behalf should allow me to see and edit the entire prompt, including the System Prompt. The Prompt is part of the 
